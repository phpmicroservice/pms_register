...
class File
{
    ...
    private static $index = [
        ...
        'wmlc'          => 'application/vnd.wap.wmlcv',
    ...
    /**
     * 文件后缀转类型
     * @param type $suffix 后缀 不带.的
     * @return bool || string
     *                  false是出错了 没有收录这个后缀
     *                  string mime类型
     */
    public static function suffix2mime(string $suffix)
    {
        if (is_string($suffix) && strlen($suffix) > 0) {
            if (isset(self::$index[$suffix])) {
                return self::$index[$suffix];
            }
        }
        return false;
    }
